 ...
 * @example
 * abc.async([url1, url2], function (url, callback) { ... }, function (results) {})
 * abc.async([func1, func2], function (results) {});
 * abc.async({one: url1, two: url2}, function (url, callback) { ... }, function (results) {})
 * abc.async({one: func1, two: func2}, function (results) {});
 */
